...
# We also tried a Second heuristic which gives score according to position of each piece        #
# which Was supposed to be better, but took more time than one based on material space          #                                              
# The uppercase letters represent the white pieces and the lowercase letters represent the black#
# pieces                                                                                        #
#################################################################################################
#References:
#[1] https://jsfiddle.net/q76uzxwe/1/
#[2] https://medium.freecodecamp.org/simple-chess-ai-step-by-step-1d55a9266977
# We tried a Second heuristic which gives score according to position of each piece
# which Was supposed to be better, but took more time than one based on material space
